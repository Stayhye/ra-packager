...
## directly where generate_retroarch.sh expects it ($1/$2.a -> beetle-vb-libretro/beetle-vb-libretro_ps2.a)
...
## Recursively find and archive ALL compiled object files safely
rm -f beetle-vb-libretro_ps2.a
find . -name "*.o" -type f | xargs mips64r5900el-ps2-elf-ar rcs beetle-vb-libretro_ps2.a || { exit 1; }

if [ ! -f "beetle-vb-libretro_ps2.a" ]; then
    echo "Error: beetle-vb-libretro_ps2.a was not created."
    exit 1
fi
