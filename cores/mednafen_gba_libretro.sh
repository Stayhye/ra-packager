...
cp -f "$REPO_FOLDER/mednafen_gba_libretro_ps2.a" ./libretro_ps2.a || { exit 1; }

mkdir -p mednafen_gba_libretro
cp -f "$REPO_FOLDER/mednafen_gba_libretro_ps2.a" mednafen_gba_libretro_ps2.a || { exit 1; }