...
REPO_URL="https://github.com/Stayhye/quasi88-libretro.git"   
REPO_FOLDER="quasi88-libretro"
BRANCH_NAME="master"
...
mkdir -p quasi88_libretro
cp -f "$FOUND_ARCHIVE" quasi88_libretro/quasi88_libretro_ps2.a || { exit 1; }