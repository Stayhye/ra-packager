...
cp -f "$REPO_FOLDER/scummvm_libretro_ps2.a" ./libretro_ps2.a || { exit 1; }

mkdir -p scummvm_libretro
cp -f "$REPO_FOLDER/scummvm_libretro_ps2.a" scummvm_libretro_ps2.a || { exit 1; }