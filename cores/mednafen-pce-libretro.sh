...
cp -f "$REPO_FOLDER/mednafen_pce_libretro_ps2.a" ./libretro_ps2.a || { exit 1; }

mkdir -p beetle-pce-libretro
cp -f "$REPO_FOLDER/mednafen_pce_libretro_ps2.a" mednafen_pce_libretro_ps2.a || { exit 1; }