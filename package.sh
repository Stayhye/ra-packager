...
#mrboom_libretro
./cores/mrboom_libretro.sh || { exit 1; }
...
#anarch-libretro
./cores/anarch_libretro.sh || { exit 1; }
...
#jollycv_libretro
./cores/jollycv_libretro.sh || { exit 1; }
...
./generate_retroarch.sh px68k_libretro px68k_libretro_ps2 || { exit 1; } 
